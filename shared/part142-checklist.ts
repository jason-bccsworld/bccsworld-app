/**
 * Canonical FAA Part 142 Training Center inspection checklist data.
 * Shared by the client (rendering) and server (org-scoped seeding).
 * Extracted from the original hard-coded checklist page.
 */
export interface Part142Item {
  id: string;
  number: string;
  description: string;
  reference: string;
...
export const PART142_CHECKLIST: Part142Area[] = [
  {
    id: 'area1',
