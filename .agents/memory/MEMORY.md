...
- [Full-coverage map-reduce AI review](mapreduce-ai-review.md) — run state server-owned, hash-bound to manuals+items, conditional transitions; never client-carried evidence or 30s-busting requests.
